...
public class MailServiceImpl implements MailService{
    ...
    public static final String NEW_PASSWORD_SUBJECT = "Change your password - WebStore-APP";
    public static final String USER_ACTIVATION_SUBJECT = "Activate your user - WebStore-APP";
    ...
    private String generateEmailNewPassword(String newPasswordCode) {
        return "<div style=\" text-align:center; width:450px; margin:10px auto; border-radius:10px;\">"
                + "<h1 style=\"color:#555555; font-size: 20px;\">Webstore-APP</h1>"
